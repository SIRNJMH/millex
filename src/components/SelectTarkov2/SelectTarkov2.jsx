...
import './SelectTarkov2.css';
import tarkov from '../../images/tarkov11.png';
  ...
  return (
    <div className="select">
      ...
      <div className="select__title_wrap">
            ...
            <p className="cards_game__title">VIKING</p>
        </div>
        ...
        <div className="select__wrapper">
            <div className="select__wrapper_functional">
                ...
                <p className="select__text">— Nicknames</p>
                <p className="select__text">— Distance</p>
                <p className="select__text">— Weapon</p>
                <p className="select__text">— HealthBar</p>
                <p className="select__text">— Skeletons</p>
                <p className="select__text">— DrawExits</p>
                </div>
                ...
                <p className="select__text">— DrawFov</p>
                <p className="select__text">— CustomFov</p>
                <p className="select__text">— Crosshair</p>
                <p className="select__text">— NoRecoil</p>
                <p className="select__text">— NoSway</p>
                <p className="select__text">— NoSpread</p>
                </div>
                <div className="select__wrapper_function">
                <div className="select__wrapper_title">
                ...
                <p className="select__text">— Show Loot</p>
                <p className="select__text">— Show items</p>
                <p className="select__text">— Show corpses</p>
                <p className="select__text">— Show containers</p>
                </div>
                ...
                <p className="select__text">— Infinity Stamina</p>
                <p className="select__text">— Oxygen</p>
                <p className="select__text">— NoVisor</p>
                <p className="select__text">— Thermal Vision</p>
                <p className="select__text">— NightVision</p>
                <p className="select__text">— AspectRatio</p>
                <p className="select__text">— Visor</p>
                <p className="select__text">— NoBreath</p>
                <p className="select__text">— FastSpeed</p>
                </div>
            </div>
            <div className="select__wrapper_prices">
                ...
                <a className="select__wrapper_link" href="https://www.millex.fun/payitem/19" target="_blank">
                <div className="select__wrapper_prices-price">
                    <p className="select__wrapper_prices-day">1 день</p>
                    <p className="select__wrapper_prices-day">390₽</p>
                </div>
                ...
                <a className="select__wrapper_link" href="https://www.millex.fun/payitem/21" target="_blank">
                    <div className="select__wrapper_prices-price">
                        ...
                        <p className="select__wrapper_prices-day">1190₽</p>
                    </div>
                </a>
            </div>
        </div>
