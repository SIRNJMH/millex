...
import './Scum.css';
import scum from '../../images/scum2.png';
    ...
    <div className="cards_game">
      <div className="cards_game__container">
        <div className="cards_game__container-title">
            ...
            <p className="cards_game__title">SCUM</p>
        </div>
        <div className="card_game__container">

        <div className="card_game">
            <Link className="card_game__link" to="/scum/millex">
            <img className="card_game__image" src={scum} alt="RUST" />
            <div className="card_game__wrapper">
                <p className="card_game__title">MILLEX SCUM</p>
