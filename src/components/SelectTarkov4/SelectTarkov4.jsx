  ...
  return (
    <div className="select">
      ...
      <div className="select__title_wrap">
            ...
            <p className="cards_game__title">MILLEX TARKOV</p>
        </div>
        ...
        <div className="select__wrapper">
            <div className="select__wrapper_functional">
                ...
                <p className="select__text">— Border Box</p>
                <p className="select__text">— Health</p>
                <p className="select__text">— Skeleton</p>
                <p className="select__text">— Nickname</p>
                <p className="select__text">— Extractions</p>
                ...
                <p className="select__text">— Max Dist.</p>
                </div>
                <div className="select__wrapper_function">
                <div className="select__wrapper_title">
                ...
                <p className="select__text">— Bone</p>
                ...
                <p className="select__text">— Show coprses</p>
                </div>
                <div className="select__wrapper_function">
                <div className="select__wrapper_title">
            ...
            <div className="select__wrapper_prices">
                ...
                <a className="select__wrapper_link" href="https://www.millex.fun/payitem/49" target="_blank">
                <div className="select__wrapper_prices-price">
                ...
                <a className="select__wrapper_link" href="https://www.millex.fun/payitem/50" target="_blank">
                    <div className="select__wrapper_prices-price">
