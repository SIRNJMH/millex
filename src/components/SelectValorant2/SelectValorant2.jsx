...
import './SelectValorant2.css';
import valorant12 from '../../images/valorant12.png';
    ...
    <div className="select">
      ...
      <div className="select__title_wrap">
        ...
        <div className="select__wrap">
            <img className="select__image" src={valorant12} alt="VALORANT2" />
...
export default SelectValorant2;