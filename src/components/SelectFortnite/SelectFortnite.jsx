...
import './SelectFortnite.css';
import fortnite from '../../images/fort11.png';
  ...
  return (
    <div className="select">
      ...
      <div className="select__title_wrap">
            <Link className="cards__game_link" to="/fortnite">
            ...
            <p className="cards_game__title">MILLEX FORTNITE</p>
        </div>
        <div className="select__wrap">
            <img className="select__image" src={fortnite} alt="VALORANT" />
        ...
        <div className="select__wrapper">
            <div className="select__wrapper_functional">
                ...
                <p className="select__text">— VisualDistance</p>
                <p className="select__text">— Team ESP - 2D BOX , Distance , Snapline</p>
                </div>
                ...
                <p className="select__text">— Triggerbot</p>
                <p className="select__text">— Aim FOV</p>
                <p className="select__text">— Smooth</p>
                <p className="select__text">— Shape</p>
                <p className="select__text">— Aim prediction</p>
                </div>
            ...
            <div className="select__wrapper_prices">
                ...
                <a className="select__wrapper_link" href="https://www.millex.fun/payitem/11" target="_blank">
                ...
                <a className="select__wrapper_link" href="https://www.millex.fun/payitem/12" target="_blank">
                <div className="select__wrapper_prices-price">
                ...
                <a className="select__wrapper_link" href="https://www.millex.fun/payitem/13" target="_blank">
                    <div className="select__wrapper_prices-price">
