...
import './SelectTarkov3.css';
import tarkov from '../../images/tarkovsel.png';
  ...
  return (
    <div className="select">
      ...
      <div className="select__title_wrap">
            ...
            <p className="cards_game__title">Titanium LITE</p>
        </div>
        <div className="select__wrap">
            <img className="select__image" src={tarkov} alt="Tarkov" />
        ...
        <div className="select__wrapper">
            ...
            <div className="select__wrapper_function">
                <div className="select__wrapper_title">
                    ...
                    <h2 className="select__title">Functional</h2>
                </div>
            ...
            <div className="select__wrapper_prices">
                <a className="select__wrapper_link" href="https://millex.fun/payitem/42" target="_blank">
                ...
                <a className="select__wrapper_link" href="https://millex.fun/payitem/43" target="_blank">
                <div className="select__wrapper_prices-price">
                ...
                <a className="select__wrapper_link" href="https://millex.fun/payitem/44" target="_blank">
                    <div className="select__wrapper_prices-price">
