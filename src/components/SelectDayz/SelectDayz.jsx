...
import './SelectDayz.css';
import dayz from '../../images/dayz3.png';
  ...
  return (
    <div className="select">
      ...
      <div className="select__title_wrap">
            <Link className="cards__game_link" to="/dayz">
            ...
            <p className="cards_game__title">MILLEX DAYZ</p>
        </div>
        <div className="select__wrap">
            <img className="select__image" src={dayz} alt="VALORANT" />
        ...
        <div className="select__wrapper">
            ...
            <div className="select__wrapper_function">
                ...
                <p className="select__text">— Отображение игроков</p>
                <p className="select__text">— Отображение дистанции</p>
                <p className="select__text">— Отображение выживших</p>
                <p className="select__text">— Отображение одежды</p>
                <p className="select__text">— Отображение магазинов</p>
                <p className="select__text">— Отображение оружия</p>
                <p className="select__text">— Отображение медикаментов</p>
                <p className="select__text">— Отображение еды</p>
                <p className="select__text">— Отображение секреток | нычек</p>
                </div>

            </div>
            <div className="select__wrapper_prices">
                <h2 className="select__wrapper_undetect">UNDETECTED</h2>
                <a className="select__wrapper_link" href="https://millex.fun/payitem/62" target="_blank">
                ...
                <a className="select__wrapper_link" href="https://millex.fun/payitem/63" target="_blank">
                <div className="select__wrapper_prices-price">
                ...
                <a className="select__wrapper_link" href="https://millex.fun/payitem/64" target="_blank">
                    <div className="select__wrapper_prices-price">
