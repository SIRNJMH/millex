...
import val4 from '../../images/val4.png';
import val5 from '../../images/val5.png';
import val6 from '../../images/val6.png';
    ...
    <div className="cards_game">
      <div className="cards_game__container">
        <div className="cards_game__container-title">
            ...
            <p className="cards_game__title">VALORANT</p>
        </div>
        <div className="card_game__container">

        <div className="card_game">
            <Link className="card_game__link" to="/valorant/aimbot">
            <img className="card_game__image" src={val1} alt="VALORANT"/>
...
{/* 
        ...
        <div className="card_game">
            ...
            <div className="card_game__wrapper">
                <p className="card_game__title">ESP 3 ДНЯ</p>
                <div className="card_game__wrap">
                    <p className="card_game__price">1490₽</p>
                    <button className="card_game__button">КУПИТЬ</button>
                </div>
            </div>
            </a>
        ...
        <div className="card_game">
            <a className="card_game__link" href="/">
            <img className="card_game__image" src={val5} alt="VALORANT"/>
            <div className="card_game__wrapper">
                <p className="card_game__title">ESP 7 ДНЕЙ</p>
                <div className="card_game__wrap">
                    <p className="card_game__price">2990₽</p>
                    <button className="card_game__button">КУПИТЬ</button>
                </div>
        ...
        <div className="card_game">
            ...
            <img className="card_game__image" src={val6} alt="VALORANT"/>
            <div className="card_game__wrapper">
                <p className="card_game__title">ESP 30 ДНЕЙ</p>
                <div className="card_game__wrap">
                    <p className="card_game__price">5990₽</p>
                    <button className="card_game__button">КУПИТЬ</button>
                </div>
            </div>
            </a>
