  ...
  return (
    <div className="select">
      ...
      <div className="select__title_wrap">
            ...
            <p className="cards_game__title">MILLEX APEX</p>
        </div>
        ...
        <div className="select__wrapper">
            <div className="select__wrapper_functional">
                <div className="select__wrapper_function">
                    ...
                    <p className="select__text">— Player Glow</p>
                    <p className="select__text">— Item Glow</p>
                    <p className="select__text">— Player Box</p>
                    <p className="select__text">— Player name</p>
                    <p className="select__text">— Player Distance</p>
                    <p className="select__text">— Line ESP</p>
                    <p className="select__text">— Health Bars </p>
                    <p className="select__text">— Armor Bars </p>
                </div>
                ...
                <div className="select__wrapper_function">
                    ...
                    <p className="select__text">— Visibility Check</p>
                    <p className="select__text">— Aimbot Key</p>
                    <p className="select__text">— Aim FOV</p>
                    <p className="select__text">— Smoothing</p>
                    <p className="select__text">— Random smoothness (min - max smoothing)</p>
                    <p className="select__text">— Dynamic Smoothness</p>
                    <p className="select__text">— Closet Too bone target</p>
                    <p className="select__text">— Choose diffrent target bones</p>
                    <p className="select__text">— Randomize bone</p>
                </div>
            ...
            <div className="select__wrapper_prices">
                <a className="select__wrapper_link" href="https://www.millex.fun/payitem/4" target="_blank">
                ...
                <a className="select__wrapper_link" href="https://www.millex.fun/payitem/5" target="_blank">
                <div className="select__wrapper_prices-price">
                    <p className="select__wrapper_prices-day">7 дней</p>
                    <p className="select__wrapper_prices-day">900₽</p>
                </div>
                </a>

                <a className="select__wrapper_link" href="https://www.millex.fun/payitem/6" target="_blank">
                    <div className="select__wrapper_prices-price">
