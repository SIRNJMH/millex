...
import './SelectRust2.css';
import rust from '../../images/rustsel.png';
  ...
  return (
    <div className="select">
      ...
      <div className="select__title_wrap">
            ...
            <p className="cards_game__title">HYPERAIM.GG</p>
        </div>
        ...
        <div className="select__wrapper">
            ...
            <div className="select__wrapper_function">
                ...
                <p className="select__text">— Type: Players, Sleepers, NPC</p>
                ...
                <p className="select__text">— Flags (safe zone, wounded)</p>
                ...
                <p className="select__text">— Watermark | prediction point</p>
                </div>
                ...
                <p className="select__text">— Enable toggle</p>
                <p className="select__text">— pSilent</p>
                <p className="select__text">— Smoothing</p>
                <p className="select__text">— FOV limit</p>
                <p className="select__text">— Prediction</p>
                <p className="select__text">— Magic bullets</p>
                <p className="select__text">— Visible check</p>
                <p className="select__text">— Target locking</p>
                <p className="select__text">— Target list (Players, Friends, NPCs, Heli)</p>
                <p className="select__text">— Hitbox</p>
                <p className="select__text">— No spread</p>
                <p className="select__text">— No sway</p>
                <p className="select__text">— Faster bullets</p>
                <p className="select__text">— Horizontal | Vertical recoil sliders</p>
                <p className="select__text">— Disable attack restrictions (shoot while jumping)</p>
                <p className="select__text">— Instant Eoka</p>
                <p className="select__text">— Instant compound bow</p>
                <p className="select__text">— Bullet thickness</p>
                <p className="select__text">— Ignore damage for teammates</p>
                <p className="select__text">— Hit override</p>
                <p className="select__text">— Hit override for helicopter</p>
                </div>
                ...
                <p className="select__text">— Jesus</p>
                <p className="select__text">— Spiderman</p>
                <p className="select__text">— Infinite Jump</p>
                <p className="select__text">— Ignore tree collision</p>
                <p className="select__text">— Silent walk</p>
                <p className="select__text">— Flyhack</p>
                <p className="select__text">— No collide</p>
                <p className="select__text">— Anti-flyhack kick</p>
                <p className="select__text">— Phase</p>
                <p className="select__text">— Giraffe (view offset/fakeduck)</p>
                <p className="select__text">— Instant loot</p>
                <p className="select__text">— Weapon spam</p>
                <p className="select__text">— Silent melee</p>
                <p className="select__text">— Silent farm (trees | ores)</p>
                <p className="select__text">— Auto collect</p>
                <p className="select__text">— Zoom hack</p>
