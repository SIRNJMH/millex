...
import './Fortnite.css';
import fort1 from '../../images/fort1.png';
import fort2 from '../../images/fort2.png';
import fort3 from '../../images/fort3.png';
    ...
    <div className="cards_game">
      <div className="cards_game__container">
        <div className="cards_game__container-title">
            ...
            <p className="cards_game__title">FORTNITE</p>
        </div>
        <div className="card_game__container">

        <div className="card_game">
            <Link className="card_game__link" to="/fortnite/millex">
            <img className="card_game__image" src={fort2} alt="FORTNITE" />
