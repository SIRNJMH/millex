...
import './Pubg.css';
import pubg from '../../images/pubg2.png';
    ...
    <div className="cards_game">
      <div className="cards_game__container">
        <div className="cards_game__container-title">
            ...
            <p className="cards_game__title">PUBG</p>
        </div>
        <div className="card_game__container">

        <div className="card_game">
            <Link className="card_game__link" to="/pubg/millex">
            <img className="card_game__image" src={pubg} alt="APEX"/>
            <div className="card_game__wrapper">
                <p className="card_game__title">MILLEX PUBG</p>
...
{/* 
        ...
        <div className="card_game">
            <Link className="card_game__link" to="/apex/esp">
            <img className="card_game__image" src={apex2} alt="APEX"/>
            <div className="card_game__wrapper">
