...
import './SelectPubg.css';
import pubg from '../../images/pubg11.png';
import eyes from '../../images/eyes.svg';
import aimbot from '../../images/aimbot.png';
    ...
    <div className="select">
      <div className="select__container">
        <div className="select__title_wrap">
            <Link className="cards__game_link" to="/pubg">
            ...
            <p className="cards_game__title">MILLEX PUBG</p>
        </div>
        <div className="select__wrap">
            <img className="select__image" src={pubg} alt="APEX SELECT" />
